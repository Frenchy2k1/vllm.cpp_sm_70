...
15. **Extension platform: Tenstorrent Blackhole (`BACKEND-TENSTORRENT`,
    ...
    `Platform` registrar), growing toward OPT-125m: EIGHT of its 9 ops now
    registered (`kMatmul`, `kMatmulBT`, `kAdd` incl. rank-1 bias broadcast,
    `kRelu`, `kEmbedding`, `kLayerNorm`, `kQkvSplit`, `kReshapeAndCache`),
    10/10 test cases passing on real Blackhole hardware
