...
| Surface coverage (`ARCH-ONE-SURFACE`) | **ROW 8 LANDED; #139 repair CPU-GREEN**: ABI v14 stable; named platform resolves via registry; DSR 39→32 (`kcuda=0`), H3 untouched | Review #139; CUDA A/B residual |
