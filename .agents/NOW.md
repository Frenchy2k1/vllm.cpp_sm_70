...
| MXFP4 parity | c1 1.020 PASS + mem 2.63x; c2-c8 0.962-0.969 (#57). Kernel side CLOSED: flash refuted (all DEVICE, params match, kernel latency-bound both engines) | Last: ~0.7ms frontend slice + c1-c2 num_splits cap + glue tail |
