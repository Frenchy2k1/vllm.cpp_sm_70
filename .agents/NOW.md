...
| Qwen3.5-4B sm_120 | #206 pretoken A/B FAIL: 98/128 exact; timings VOID. Atomic wave CPU-green | Review; GPU A/B |
...
3. **Qwen3.5-4B #206:** atomic admission CPU-green; review, GPU/vLLM rerun.
