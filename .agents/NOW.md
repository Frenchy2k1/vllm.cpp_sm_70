...
| Qwen3.5-4B sm_120 | #206 K4+postconv Pareto win; IDs exact. Cross-engine tput/TTFT VOID; TPOT/VRAM OPEN | Pretokenize; rerun |
...
3. **Qwen3.5-4B #206:** pretokenize benchmark; rerun cross-engine.
