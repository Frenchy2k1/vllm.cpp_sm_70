...
|---|---|---|
| `SPEC-DSPARK` | **WORKS on 35B**: ON==OFF 48/48 | Draft step ~6x a target |
| State record (#166) | **157 imports = 3,231,342 bytes** at `776c56f1` | Force-update #166 |
| Laguna NVFP4 / DS-V4 decode | **CLOSED, byte-exact**: 1.03x vLLM, 1.144x ds4 | Laguna K-run |
| 27B NVFP4 @`0893e160` | **c1 0.838, c2-c8 0.95-0.97** (#213 levers ACTIVE); c1 unmoved | c1 decode window |
...
| `SERVE-METRICS` async (#277) | **`/metrics` was DEAD on the shipped server**; now live, ctest 366/366 | Config-gated families |
