...
| Qwen3.5-4B sm_120 | Exact: tput **1.0283x**; TTFT/TPOT/E2E **1.0853/1.0165/1.0288x slower**; VRAM +118.7 MiB | Profile TTFT split |
...
3. **Qwen3.5-4B #206:** tput +2.83%; latency/VRAM open. Profile TTFT split.
