...
| Qwen3.5-4B sm_120 | #206 pretoken A/B FAIL: 98/128 exact; timings VOID. Sequential publish changes wave | Atomic admission; rerun |
...
3. **Qwen3.5-4B #206:** atomic admission, review, then GPU/vLLM rerun.
