...
7. **`ROAD-V1-C8` /metrics + streaming parser + utility endpoints** `[H]` (oldest T0
   ...
   (`test_parser_engine_assembly` 9 scenarios, 1652/1652, RED-first). Remaining W:
   serving-SSE dispatch swap + JSON-schema arg coercion + the other 6 engine configs;
