...
7. **`ROAD-V1-C8` /metrics + streaming parser + utility endpoints** `[H]` (oldest T0
   ...
   (`SERVE-UTILITY-ENDPOINTS` ACTIVE). Remaining W: `TOOLS-STREAMING-PARSER` unified
   engine + `SERVE-RESPONSE-METRICS` + live-engine metric value wiring. **Gate:** metric-name
