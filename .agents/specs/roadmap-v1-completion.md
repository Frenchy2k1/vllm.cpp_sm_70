...
7. **`ROAD-V1-C8` /metrics + streaming parser + utility endpoints** `[H]` (oldest T0
   ...
   30 scenarios, RED-first 38 asserts). Remaining W:
   the chat/completion RESPONSE-BODY timing surface;
