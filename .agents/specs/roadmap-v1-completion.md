...
7. **`ROAD-V1-C8` /metrics + streaming parser + utility endpoints** `[H]` (oldest T0
   ...
   OFF by default). Remaining W:
   JSON-schema arg coercion + the other 6 engine configs;
   `SERVE-RESPONSE-METRICS` + live-engine metric value wiring.
   **Gate:** metric-name
