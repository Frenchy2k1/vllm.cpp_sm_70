...
7. **`ROAD-V1-C8` /metrics + streaming parser + utility endpoints** `[H]` (oldest T0
   ...
   RED-first). Remaining W: the parser ASSEMBLY layer + serving-SSE dispatch swap + the
   other 6 engine configs; `SERVE-RESPONSE-METRICS` + live-engine metric value wiring.
   **Gate:** metric-name
