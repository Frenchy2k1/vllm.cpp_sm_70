...
7. **`ROAD-V1-C8` /metrics + streaming parser + utility endpoints** `[H]` (oldest T0
   ...
   gate 44 asserts, RED-first). Remaining W:
   JSON-schema arg coercion;
   `SERVE-RESPONSE-METRICS`; AsyncLLM serving-path metric wiring + config-gated families.
   **Gate:** metric-name
