...
// No launcher edit. Two tactics are registered today — the existing sm_12x
// native fp4 path and the sm_70 NVFP4 W4A16 decode path (kSm70Nvfp4W4a16) —
// so each is disabled on the other architecture; the value of this header is
// the shape, and the population grows per architecture.
//
