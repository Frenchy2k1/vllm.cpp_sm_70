...
pv = np.fromfile(os.path.join(FIX, "pixel_values_videos_f32.bin"), dtype=np.float32).reshape(256, 1536)
grid_thw = np.fromfile(os.path.join(FIX, "video_grid_thw_i64.bin"), dtype=np.int64).reshape(3).tolist()
