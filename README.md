...
| Metal | Apple Silicon | Two models run end to end and pass correctness; 18 of 75 ops native. Warm b=1 throughput is 95.8% of MLX-LM. Indicative ([BENCHMARKS](docs/BENCHMARKS.md)) |
