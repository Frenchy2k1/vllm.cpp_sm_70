...
| Metal | Apple Silicon | Two models run end to end and pass correctness (OPT-125m, Qwen3-0.6B); 18 of 75 ops native, rest fall back to CPU. Kernel work puts b=1 warm decode at 95.4% of MLX-LM and total throughput at 89.4% (thermally matched); the residual is 61% prefill GEMM, 39% decode dispatch count, both needing new algorithms. Indicative ([BENCHMARKS](docs/BENCHMARKS.md)) |
