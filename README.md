...
| Metal | Apple Silicon | Two models run end to end and pass correctness (OPT-125m, Qwen3-0.6B); 18 of 75 ops native, rest fall back to CPU on unified memory. Batched command buffers, a decode GEMV, a simdgroup-matrix GEMM and typed loads put b=1 at 17.4 tok/s vs MLX-LM's 27.9. Vectorised loads brought the GEMM to 76-86% of MLX's; B-tile vectorisation measured neutral. Indicative ([BENCHMARKS](docs/BENCHMARKS.md)) |
