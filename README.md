...
| Metal | Apple Silicon | Two models run end to end and pass correctness (OPT-125m, Qwen3-0.6B); 18 of 75 ops native. Warm b=1 throughput is 94.5% of MLX-LM; the residual is decode attention at 24% of peak bandwidth. Indicative |
