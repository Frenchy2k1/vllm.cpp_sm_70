...
| Metal | Apple Silicon | Two models run end to end and pass correctness (OPT-125m, Qwen3-0.6B); 18 of 75 ops native, rest fall back to CPU. Kernel work puts b=1 decode at 26.6 tok/s vs MLX-LM's 27.9 (95.4%); query-tiled prefill lifts a 4096-token prompt 32%. Prefill GEMM gap open. Indicative ([BENCHMARKS](docs/BENCHMARKS.md)) |
