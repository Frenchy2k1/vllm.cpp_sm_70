...
| Metal | Apple Silicon | Two models run end to end and pass correctness (OPT-125m, Qwen3-0.6B); 18 of 75 ops native, rest fall back to CPU. Kernel work puts b=1 warm decode at 95.4% of MLX-LM and total throughput at 89.4% (thermally matched); mma prefill attention (4.3x) puts warm throughput at 94.5% of MLX-LM; the residual is now 63% decode dispatch count, 37% prefill. Indicative ([BENCHMARKS](docs/BENCHMARKS.md)) |
