...
| Metal | Apple Silicon | Two models run end to end and pass correctness (OPT-125m, Qwen3-0.6B); 18 of 75 ops native. Kernel work incl. mma prefill attention (4.3x) puts warm b=1 throughput at 94.5% of MLX-LM; the residual is decode attention at 24% of peak bandwidth; four decode hypotheses tested and refuted; further tuning uses scripts/metal-paired-ab.py. Indicative ([BENCHMARKS](docs/BENCHMARKS.md)) |
