...
| Voxtral audio encoder TTFT (`VT_WHISPER_ENC_FA2`, #432) | FA-2 tensor cores, hd-64 encoder attention: 731.7 -> 133.0 ms (5.50x), TTFT ~17.1x -> ~3.11x vs vLLM | **OPT-IN**: costs 3 near-tie divergences (band PASS) vs 0. Developer decision |
