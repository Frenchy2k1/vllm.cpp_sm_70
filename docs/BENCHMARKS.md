...
| **Binary release delivery topology** | PR `196`; single PR for W1-W13. W1 source-gencode/mutation gates are locally green | Real ten-SM CUDA build/cubin audit pending; accepted archive evidence remains W6 1/1 | n/a |
