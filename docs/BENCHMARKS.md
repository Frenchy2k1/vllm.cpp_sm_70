...
| **sm70 NVFP4 decode GEMM microbench (`sm70-nvfp4-gemm`)** | V100 32 GB (GPU 0,1), `LaunchSm70Nvfp4W4a16`, 27B TP-2 per-rank shapes | M=4/8 **345–629 GB/s**, up from ~52–59; M=1/2 388–546 (SIMT roofline). Detail in [the benchmark record](../.agents/benchmark-record.md) | parity `test_sm70_nvfp4_gemm` A/D/E/F OK, informational |
