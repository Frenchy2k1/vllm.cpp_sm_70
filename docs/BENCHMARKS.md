...
| DSpark | 27B NVFP4 dense k=15; 35B-A3B MoE k=8 | vs the **pinned, graphed** oracle: MoE **0.975x** on the code cell under PINNED CLOCKS (non-overlapping, 30 reps); 1.012x on the prose cell. NOT parity. W8 captures the T=1+k verify (#442): +12.2%/+3.5%, byte-identical | `ACTIVE` |
