...
| **Muse Glimmer 30B (#268)** | no denominator: the pin carries no `muse_glimmer` | **OPEN GAP on every axis; no number claimed, none waived.** Unblocks when vllm#51655 merges and the pin advances | correctness only at depth 4/52, no generated tokens; see #333 |
