...
| Tenstorrent Blackhole (`BACKEND-TENSTORRENT`) | **NOT APPLICABLE.** `ACTIVE` W1.5: 9/9 OPT-125m ops (PA host oracle); 11/11 tests PASS real HW. [Spec](../.agents/specs/tenstorrent-backend.md) | Device-resident tensors + ttnn::sdpa_decode for real PA perf |
