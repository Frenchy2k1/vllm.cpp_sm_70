...
|---|---|---|---|
| **Developer agent entry point (design)** | `DOCS-AGENT-PROTOCOL-ENTRYPOINT`: public contribution guide + synchronized pre-claim intake rule | Documentation/protocol only; benchmark void | n/a |
