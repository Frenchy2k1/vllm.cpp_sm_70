...
|---|---|---:|---:|---:|---|
| RTX 5070 Ti (`sm_120`) | Qwen3.5-4B BF16, c32, steady-interval total | 233.955 ms | 145.421 ms | **1.609x slower** | Exact chunks are 3.072x faster. Next: K=4 specialization, then a 256-channel tile ([spike](../.agents/specs/sm120-qwen35-conv-channel-tile-2026-08-08.md)) |
