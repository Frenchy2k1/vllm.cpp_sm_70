...
| DSpark | 27B NVFP4 dense k=15; 35B-A3B MoE k=8 | vs the **pinned, graphed** oracle: MoE **0.996x-1.012x** on MATCHED WORK; residual BELOW resolution (distributions overlap). W8 captures the T=1+k verify (#442): +12.2%/+3.5%, byte-identical | `ACTIVE` |
