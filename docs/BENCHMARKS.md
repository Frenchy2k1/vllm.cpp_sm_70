...
| Qwen3.5-4B | bf16 direct-load | 0.26.0.dev0 | **total/output throughput 1.0283x; host PSS lower** | Corrected exact comparison: throughput 1.0283x. OPEN: TTFT/TPOT/E2E 1.0853/1.0165/1.0288x slower; VRAM +118.7 MiB. Local GDN opt-ins improve every timing axis ([data](bench-evidence/qwen35-4b-sm120-main-20260807.md)) |
