...
|---|---|---|
| Surface coverage (`ARCH-ONE-SURFACE`) | **CORRECTNESS COMPLETE:** #139 restores DSR 32 (`kcuda=0`) via registry/name resolution; ABI-v14 selection unchanged; no speed claim | Selector 2/2·11 plus semantic CMake/File-API/CTest guard 23/23; CPU platform/loader/C-ABI tests green; CUDA A/B remains residual |
