...
|---|---|---|
| Surface coverage (`ARCH-ONE-SURFACE`) | **CORRECTNESS COMPLETE:** #139 restores DSR 32 (`kcuda=0`) via registry/name resolution; ABI-v14 selection unchanged; no speed claim | Distinctive-platform selector gate 2/2·11 (identity, exact name, propagated type); CPU platform/loader/C-ABI tests green; CUDA A/B remains residual |
