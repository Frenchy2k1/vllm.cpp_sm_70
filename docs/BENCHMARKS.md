...
| Vulkan vs llama.cpp Vulkan (`BENCH-VK-LLAMA`) | **Both arms measured, same weights.** llama.cpp Vulkan `NV_coopmat2`: pp128 **11,514 t/s**, tg32 **160.9 t/s**. vllm.cpp Vulkan: prefill **137.7**, decode **87.3 t/s** | Decode **8.59 -> 87.3 t/s** (**10.2x**), **1.84x** off llama.cpp; 6/6 exact. Ring 16->128 alone **1.51x** (8/8); host-bound. VOID: subgroup, Tier-1 fusion, GEMV unroll. #125 fix unrun off-CUDA |
