...
|---|---|---:|---:|---:|---|
| RTX 5070 Ti (`sm_120`) | Qwen3.5-4B BF16, c32, steady-interval total | 233.955 ms default; **219.506 ms** K4 arm 1 | 145.421 ms | 1.609x default; **1.509x** arm 1 | K4 arm 1 is byte-exact and **6.44% faster**; arm 2 falsified. Arm 1 stays opt-in ([result](../.agents/specs/sm120-qwen35-conv-channel-tile-2026-08-08.md)) |
