...
anchor-backfill work, the operator/helper protocol W0-W5, anchor-backfill batches 3-4, and the upstream-derived inventory tooling, touched no engine code and moved no number: NOT
