...
| Voxtral encoder TTFT (`VT_WHISPER_ENC_FA2`, #432) | FA-2 hd-64 encoder attn: 731.7 -> 133.0 ms (5.50x), TTFT ~17.1x -> ~3.11x | **OPT-IN**: 3 near-tie divergences (band PASS) vs 0. Developer call |
