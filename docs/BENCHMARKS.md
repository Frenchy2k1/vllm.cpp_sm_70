...
| DSpark | 27B NVFP4 dense k=15; 35B-A3B MoE k=8 | MoE **0.975x** code / **1.012x** prose vs the pinned graphed oracle (PINNED CLOCKS, non-overlapping). NOT parity: 8.2% sits inside the SAME Marlin MoE kernel (#442) | `ACTIVE` |
