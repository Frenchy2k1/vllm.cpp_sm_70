...
| **Binary release delivery topology** | Machine fields pin PR `196` and `single-pr-W1-W13` | Topology only; W1-W4/W7-W13 remain pending and accepted archive evidence remains W6 1/1 | n/a |
