...
`BACKEND-TENSTORRENT`: `ACTIVE` W0 skeleton (ttnn adapter, one op — `kMatmul`, F32/rank-2), 3/3 tests PASS real Blackhole HW. Not reviewed. [Spec](../.agents/specs/tenstorrent-backend.md).
