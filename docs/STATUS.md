...
| Qwen3.5-4B plain BF16 direct loading on discrete CUDA | Correctness-complete; atomic frontend wave pending; TPOT/VRAM open | #206 real pretoken A/B FAILED exactness (98/128); timings VOID. Atomic wave admission pending; TPOT 1.025x, VRAM +233 MiB OPEN ([data](bench-evidence/qwen35-4b-sm120-main-20260807.md)) |
...
The restored selectors remain default OFF.
