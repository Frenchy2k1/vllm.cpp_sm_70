...
`BACKEND-TENSTORRENT`: `ACTIVE` W1.1 (ttnn adapter, 5/9 OPT-125m ops — `kMatmul`/`kMatmulBT`/`kAdd`/`kRelu`/`kEmbedding`), 7/7 tests PASS real Blackhole HW. Not reviewed. [Spec](../.agents/specs/tenstorrent-backend.md).
