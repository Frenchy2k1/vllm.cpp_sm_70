...
`BACKEND-TENSTORRENT`: `INVENTORIED` proposal, ttnn adapter, no `src/vt/` code yet. Spike-validated on real Blackhole HW (matmul, bf16 tolerance). [Spec](../.agents/specs/tenstorrent-backend.md).
