...
`BACKEND-TENSTORRENT`: `ACTIVE` W1.4 (ttnn adapter, 8/9 OPT-125m ops — +`kReshapeAndCache` host-staged), 10/10 tests PASS real Blackhole HW. Not reviewed. [Spec](../.agents/specs/tenstorrent-backend.md).
