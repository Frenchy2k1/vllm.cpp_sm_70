...
residency is already staged correctly (cudaMalloc + one upload), so the cause is
memory-system behaviour for our ~512 MB single-slab expert allocation. Editing
