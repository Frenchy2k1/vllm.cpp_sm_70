...
`BACKEND-TENSTORRENT`: `ACTIVE` W1.5 (ttnn adapter, 9/9 OPT-125m ops — +`kPagedAttention` host-staged oracle), 11/11 tests PASS real Blackhole HW. Not reviewed. [Spec](../.agents/specs/tenstorrent-backend.md).
