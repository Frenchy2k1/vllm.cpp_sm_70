...
this device's own GEMM; its online softmax uses 12% of the threadgroup while the
mma stages either side use all of it. The V-accumulation win came from BISECTING the attention
