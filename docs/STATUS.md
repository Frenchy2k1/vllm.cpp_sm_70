...
`BACKEND-TENSTORRENT`: `ACTIVE` W2 — OPT-125m e2e STRICT token-exact 6/6·96/96 on real Blackhole (device type 6, 0 declines, kPagedAttention selections=1152). Not reviewed. [Spec](../.agents/specs/tenstorrent-backend.md).
