...
| Qwen3.6-35B-A3B (NVFP4, GDN MoE) | Correctness-complete; fresh 3-rep grid 2026-08-05: 0.93-1.03x | Token-exact greedy (gate=0); tput c4 1.025x, c16 0.932x, TTFT 0.93-0.98x. c16 drain-sync lever A/B'd NEGATIVE 2026-08-06 (blocking-event -1.9%, drain KEPT); cost = depth-2 serialization, fix = GPU-resident sampled tokens |
