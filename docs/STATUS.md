...
`BACKEND-TENSTORRENT`: `ACTIVE` W1 (ttnn adapter, 4/9 OPT-125m ops — `kMatmul`/`kMatmulBT`/`kAdd`/`kRelu`, F32/rank-2), 6/6 tests PASS real Blackhole HW. Not reviewed. [Spec](../.agents/specs/tenstorrent-backend.md).
