...
|---|---|---|
| Qwen3.6-27B (NVFP4) text generation | Correctness-complete; speed is CHECKPOINT-dependent | Token-exact GB10 on both. `unsloth` @`890bdef7` beats vLLM every c (1.007-1.045x), 115/124; `nvidia` @`0893e160` **0.85x BEHIND**; its NVFP4 `lm_head` now PACKED (#213, RSS -1.70 GiB) |
