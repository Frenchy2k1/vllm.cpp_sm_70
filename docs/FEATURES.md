...
| `MuseGlimmerForConditionalGeneration` | none (weights not downloaded) | scaffold: registry+config+name-map gated 11/11, forward refuses | not measurable; anchored to open vllm#51655, pin advance owed |
