...
| `MuseGlimmerForConditionalGeneration` | none (no checkpoint run) | Same W1 text tower; the perception encoder still refuses (W3), so image/video prompts are not served | not measurable; anchored to open vllm#51655, pin advance owed |
