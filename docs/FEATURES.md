...
| DSpark (semi-autoregressive block drafter) | ☐ **runs on the 35B gate model, drafter still inert** ([spec](../.agents/specs/dspark-spec-decode.md)): zero verified draft tokens, spec-on 5.5x slower; no claim | ✅ | ◐ |
