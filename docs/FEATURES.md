...
| GGUF k-quants and i-quants | ✅ (CPU grouped keep-quant MoE bf16-activation regression in `b4f5610a` fixed 2026-08-06). **CPU quant compute is ISA-tiered:** Arm has i8mm + repack, x86_64 portable-only (CIQ `G5`, #433) | ☐ | ☐ | ✅ |
| AWQ | ◐ CPU dequant | ✅ | ✅ | ☐ |
| GPTQ | ◐ CPU dequant | ✅ | ✅ | ☐ |
