...
set(VT_CUDA_FEATURE_TABLE
  ...
  "sm70-nvfp4-gemm|7.0|sm70 W4A16 NVFP4 decode GEMM (SIMT M<=3, QPN m8n8k4 M4..16, WMMA M4..64)"
  # Volta FA2 fragment core, vendored (third_party/flash_attn_v100/; upstream
  # 1Cat-vLLM flash-attention-v100). sm_70-only by construction. The decode and
  # prefill attention bodies built on it live in cuda_sm70_flash_attn.cu; this
  # cell gates the vendored core's compile on that arch.
  "sm70-fa2-v1|7.0|Volta FA2 fragment core + paged decode (cuda_flash_attn_v100.cu, cuda_sm70_flash_attn.cu)")
